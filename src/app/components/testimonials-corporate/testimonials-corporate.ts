...
export class TestimonialsCorporate implements AfterViewInit, OnDestroy {
  ...
  cards: TestiCard[] = [
    {
      logo: 'client-logos/numerify.png',
      ...
      name: 'Numerify Inc.',
      title: 'San Jose, USA',
      letterUrl: 'testimonial-letter/Numerify.png',
    },
    {
      logo: 'client-logos/mjunction.png',
      ...
      letterUrl: 'testimonial-letter/mJunction.png',
    },
    {
      logo: 'client-logos/csir_neeri.png',
      ...
      letterUrl: 'testimonial-letter/CSIR-NEERI.png',
    },
    {
      logo: 'client-logos/strategy-academy.jpg',
      quote: '"The Academy took the services of insAnalytics for delivering training modules in Data Analytics and Machine Learning, leveraging the academic background as well as industry experience of their pool of faculty members. We are thankful to insAnalytics for successfully conducting the above mentioned sessions for our end customers in these niche and emerging areas. The sessions conducted by them were found as satisfying to our participants."',
      name: 'Prof. Ranjan Das',
      title: 'Chairman, The Strategy Academy',
      letterUrl: 'testimonial-letter/strategy-academy.png',
    },
    {
      logo: 'client-logos/eRevMax.png',
      ...
      letterUrl: 'testimonial-letter/eRevMax.png',
    },
    {
      logo: 'client-logos/Symbiosis.png',
      quote: '"The three-day programme was exceptionally well-structured and insightful. The sessions provided our faculty members with deep practical knowledge and a fresh perspective on the evolving role of AI in the business landscape. The expertise shared by your team has tremendously benefited our academic community, equipping them with industry-relevant tools and methodologies that will undoubtedly enhance our curriculum delivery."',
      name: 'Dr. Dhanya Pramod',
      title: 'Director, Symbiosis Centre for Information Technology (SCIT), Pune',
      letterUrl: 'testimonial-letter/Symbiosis.png',
    },
    {
      logo: 'client-logos/IMI.png',
      ...
      letterUrl: 'testimonial-letter/IMI.png',
    },
    {
      logo: 'client-logos/VNIT.jpg',
      ...
      letterUrl: 'testimonial-letter/VNIT.png',
    },
    {
      logo: 'client-logos/AIM.webp',
      ...
      letterUrl: 'testimonial-letter/AIM.png',
    },
    {
      logo: 'client-logos/Heritage.png',
      quote: '"insAnalytics has been selected as one of our preferred external knowledge partners. Students who have undergone training conducted by insAnalytics on Data Analytics, Big Data, Machine Learning, and Data Mining are not only conceptually stronger but also competent enough to take up projects in these niche areas — helping them secure admissions to premier institutes and excel in campus placements in these emerging domains."',
      name: 'Dr. Subhashis Majumder',
      title: 'Professor & HoD, CSE Dept. | Dean, UG Programme, Heritage Institute of Technology, Kolkata',
      letterUrl: 'testimonial-letter/Heritage.png',
    },
    {
      logo: 'client-logos/Assam.png',
      ...
      letterUrl: 'testimonial-letter/Assam.png',
    },
  ];
